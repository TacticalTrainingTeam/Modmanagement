...
class CfgVehicles {
	...
	*/
	...
	class TTT_backpack_radio_base_olive : TTT_Radiobackpack_Base {
		...
		hiddenSelections[] = {"Camo1"};
		hiddenSelectionsTextures[] = {"\ttt_units_base\data\TTT_backpack_radio_olive_co.paa"};
	};
};
...
class CfgWeapons {
	...
	*/
	...
	class TTT_Helmet_Buzzard : TTT_Helmet_Base {
		...
		hiddenSelectionsTextures[] = { "\ttt_units_base\data\TTT_helmet_buzzard.paa" };
		scope = 2;
	...
	class TTT_Helmet_Falcon : TTT_Helmet_Base {
		...
		hiddenSelectionsTextures[] = { "\ttt_units_base\data\TTT_helmet_falcon.paa" };
		scope = 2;
	...
	class TTT_Helmet_Eagle : TTT_Helmet_Base {
		...
		hiddenSelectionsTextures[] = { "\ttt_units_base\data\TTT_helmet_eagle.paa" };
		scope = 2;
	...
	class TTT_Helmet_Yellow_Vehiclecrew : H_HelmetCrew_I {
		...
		hiddenSelectionsTextures[] = { "\ttt_units_base\data\TTT_helmet_yellow_vehiclecrew.paa" };
	};
	...
	*/
	...
	class TTT_Vest_Heavy_Base : V_PlateCarrier3_rgr {
		...
		hiddenSelections[] = { "camo" };
		hiddenSelectionsTextures[] = { "\ttt_units_base\data\vest_yellow_co.paa" };
	...
	class TTT_Vest_Crew_Bronze : TTT_Vest_Crew_Base {
		...
		hiddenSelections[] = {"camo"};
		hiddenSelectionsTextures[] = {"\ttt_units_base\data\TTT_vest_bronze_co.paa"};
	};
	...
	class TTT_Vest_Crew_Silver : TTT_Vest_Crew_Base {
		...
		hiddenSelections[] = {"camo"};
		hiddenSelectionsTextures[] = {"\ttt_units_base\data\TTT_vest_silver_co.paa"};
	};
	...
	class TTT_Vest_Crew_White : TTT_Vest_Crew_Base {
		...
		hiddenSelections[] = {"camo"};
		hiddenSelectionsTextures[] = {"\ttt_units_base\data\TTT_vest_white_co.paa"};
	};
};