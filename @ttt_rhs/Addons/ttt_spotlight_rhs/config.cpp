...
class RscDisplayMain: RscStandardDisplay
{
	class Spotlight
	{
		class TTTServerRHS
		{
			...
			picture = "ttt_rhs\ttt_spotlight_rhs\button.paa"; // Square picture, ideally 512x512
			//video = "\a3\Ui_f\Video\spotlight_1_Apex.ogv"; // Video played on mouse hover
			action = "0 = [_this, 'game.tacticalteam.de', '2332', '130'] execVM 'ttt_rhs\ttt_spotlight_rhs\joinServer.sqf';";
